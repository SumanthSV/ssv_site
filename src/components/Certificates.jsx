...
const Certificates = () =>{
    ...
    return (
      ...
      //         </div>
        ...
        <div data-aos="fade-in" data-aos-duration="15000" key={id} className=''> 
            <div className='relative overflow-hidden'> 
                <img src={src} alt="Loading" className='rounded-md duration-200 hover:scale-105 w-full' /> 
                <div className='absolute bottom-0 w-full h-1/2 bg-gradient-to-t from-green-950 to-green-20 opacity-90 '></div> 
                <div className=' absolute bottom-5 left-0 w-full p-8 text-darkWhite'> 
